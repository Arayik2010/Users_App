...
const CustomPropsContainer =
  (Component: any, dataAcceptance: any, innerProps: any) =>
    ({ ...props }) => {
      return (
        <Component
          {...props}
          innerProps={Object.assign({ test: "test" }, props.payload, {
...
function Dashboard() {
  const CustomIcon = (props: any) => {
    ...
    if (name === "Clubs") {
      return (
        <>
          {/* {props.innerProps.dataType === "investments" ? ( */}
          <>
            <svg
              x={x + width / 2}
              y={y + height - 40}
  ...
  return (
    <ResponsiveContainer width="100%" height={700} aspect={3}>
      <BarChart
        width={500}
        height={700}
        data={data}
      ...
      >
        <Bar dataKey="pv" stackId="a" fill="#8884d8">
          <LabelList
            dataKey="name"
            content={CustomPropsContainer(CustomIcon, "CustomIcon", {
        ...
        <Bar dataKey="lv" stackId="a" fill="blue">
          <LabelList
            dataKey="name"
            content={CustomPropsContainer(CustomIcon, "CustomIcon", {
              dataType: "pensions",
